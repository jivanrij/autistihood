<div class="container mx-auto flex justify-center mt-14">
    <div class="w-full mx-4 text-center">
        <p class="text-base mb-6 md:text-lg md:mb-12">
            We'd like to thank these <x-accent-text>Autism Society</x-accent-text> for supporting us
        </p>
...
{{--                <x-sponsor-logo size="medium" url="https://eventy.io/?utm_source=Laravel.io&utm_campaign=eventy&utm_medium=advertisement" logo="{{ asset('images/sponsors/as.svg') }}" company="Eventy" />--}}
{{--            </div>--}}
{{--        </div>--}}
